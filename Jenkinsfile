node {
    ...
    stage "Deploy"
        ...
        //sh "echo ${lastoutput}"
        sh "kubectl apply --as=kubernetes-admin -f  https://raw.githubusercontent.com/Marc-Velay/kubernetes-ci-cd/master/applications/hello-kenzan/k8s/deployment.yaml"
